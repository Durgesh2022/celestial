    ...
    <div className="px-4 py-8 flex items-center">
      <div className="flex flex-col md:flex-row gap-8">
        <div className="md:w-1/3">
          ...
          <p className="mb-6">Find answers to your questions about our Reiki certification course and related services.</p>
          <button className="border border-gray-300 py-2 px-6 hover:bg-gray-100 transition-colors">
            Contact
          </button>
        </div>
