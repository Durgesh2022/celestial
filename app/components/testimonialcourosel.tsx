...
export default function FancyTestimonialsSlider({
  ...
  return (
    <div className="mx-auto w-full max-w-3xl text-center">
      ...
      <div className="pointer-events-none absolute left-1/2 top-0 h-[480px] w-[480px] -translate-x-1/2 before:absolute before:inset-0 before:-z-10 before:rounded-full before:bg-gradient-to-b before:from-black/25 before:via-black/5 before:via-25% before:to-black/0 before:to-75%">
