...
const Carousel = () => {
  ...
  return (
    <div className="flex flex-col w-full min-h-[800px]  flex justify-center items-center p-8 md:p-10">
      <h1 className="text-5xl font-bold mb-4  text-center">Our Offerings</h1>
      ...
      <div className="flex flex-col md:flex-row w-full">
        ...
        <div className="w-full md:w-3/5 p-4 md:p-0 md:pr-8 text-left flex flex-col justify-center">
          <h2 className="text-5xl text-black font-bold mb-2">{products[activeIndex].name}</h2>
      ...
      <div className="w-full flex justify-center py-10 relative left-[-60px]">
        <div className="flex space-x-2">
          <button
            onClick={prevSlide}
            className="p-4 bg-black rounded-full shadow-md text-white hover:bg-gray-800 transition"
          >
            <FaChevronLeft />
          </button>
          <button
