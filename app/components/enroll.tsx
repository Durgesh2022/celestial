  ...
  return (
    <div className={`w-full min-h-screen ${inter.className} px-4 py-12 md:px-16`}>
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-4">
          <p className="text-lg font-medium">Enroll</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div>
            ...
            <p>Select the Reiki level that suits your needs.</p>
          </div>
          ...
          <div>
            ...
            <p>Fill out the registration form and submit.</p>
          </div>
          ...
          <div>
            ...
            <p>Access your course materials and begin your journey.</p>
          </div>
        </div>
        
        {/* CTA Buttons */}
        <div className="flex flex-wrap gap-6">
          <Link href="/learn-more" className="inline-block border border-black px-8 py-3 font-medium">
            Learn More
          </Link>
          <Link href="/sign-up" className="inline-flex items-center gap-2 font-medium">
            Sign Up
